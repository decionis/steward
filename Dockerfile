...
LABEL org.opencontainers.image.source="https://github.com/decionis/steward" \
      ...
      org.opencontainers.image.description="A governed surface for operators to review customer and account decisions. Policy authority stays with the Decionis platform; the image holds no policy, credential or customer data." \
