...
LABEL org.opencontainers.image.source="https://github.com/decionis/steward" \
      ...
      org.opencontainers.image.description="Customer and account decisions with their evidence in view: where each data point came from, how fresh it is, and what led to the recommendation. Operators review; the Decionis platform decides, records and executes. The image holds no policy, credential or customer data." \
