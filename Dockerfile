...
LABEL org.opencontainers.image.source="https://github.com/decionis/steward" \
      ...
      org.opencontainers.image.description="Review console for customer operations: processing-limit reviews, expansion, friction and KYC/KYB escalations in one queue with the evidence behind each; reviews recorded and executed by the Decionis platform. Holds no policy, credential or customer data." \
