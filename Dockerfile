...
LABEL org.opencontainers.image.source="https://github.com/decionis/steward" \
      ...
      org.opencontainers.image.description="Signal capture and decisioning for enterprise customer operations: the operator tier over the Decionis platform. Demo mode by default; live mode against a Decionis tenant." \
